...
public class CustomerBindingProxy{
    ...
    public class Descriptor {
        private com.sadad.ebpp.wsdl.customer._1.Customer _service = null;
        private com.sadad.ebpp.wsdl.customer._1.CustomerPort _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.sadad.ebpp.wsdl.customer._1.Customer(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            _proxy = null;
            _dispatch = null;
            _service = new com.sadad.ebpp.wsdl.customer._1.Customer();
            initCommon();
        }

        private void initCommon() {
            _proxy = _service.getCustomerBinding();
        }
