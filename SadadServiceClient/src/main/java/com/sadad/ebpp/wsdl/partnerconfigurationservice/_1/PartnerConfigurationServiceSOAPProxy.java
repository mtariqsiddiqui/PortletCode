...
public class PartnerConfigurationServiceSOAPProxy{
    ...
    public class Descriptor {
        private com.sadad.ebpp.wsdl.partnerconfigurationservice._1.PartnerConfigurationService_Service _service = null;
        private com.sadad.ebpp.wsdl.partnerconfigurationservice._1.PartnerConfigurationService _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.sadad.ebpp.wsdl.partnerconfigurationservice._1.PartnerConfigurationService_Service(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            _proxy = null;
            _dispatch = null;
            _service = new com.sadad.ebpp.wsdl.partnerconfigurationservice._1.PartnerConfigurationService_Service();
            initCommon();
        }

        private void initCommon() {
            _proxy = _service.getPartnerConfigurationServiceSOAP();
        }

        public com.sadad.ebpp.wsdl.partnerconfigurationservice._1.PartnerConfigurationService getProxy() {
            return _proxy;
        }

        public Dispatch<Source> getDispatch() {
            if (_dispatch == null ) {
                QName portQName = new QName("http://www.sadad.com/EBPP/wsdl/PartnerConfigurationService/1.0", "PartnerConfigurationServiceSOAP");
