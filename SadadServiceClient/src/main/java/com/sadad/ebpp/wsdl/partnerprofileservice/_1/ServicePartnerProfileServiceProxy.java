...
public class ServicePartnerProfileServiceProxy{
    ...
    public class Descriptor {
        private com.sadad.ebpp.wsdl.partnerprofileservice._1.ServicePartnerProfileService _service = null;
        private com.sadad.ebpp.wsdl.partnerprofileservice._1.PartnerProfileService _proxy = null;
        ...
        public Descriptor(URL wsdlLocation, QName serviceName) {
            _service = new com.sadad.ebpp.wsdl.partnerprofileservice._1.ServicePartnerProfileService(wsdlLocation, serviceName);
            initCommon();
        }
        ...
        public void init() {
            ...
            _proxy = null;
            _dispatch = null;
            _service = new com.sadad.ebpp.wsdl.partnerprofileservice._1.ServicePartnerProfileService();
            initCommon();
        }

        private void initCommon() {
            _proxy = _service.getServicePartnerProfileService();
        }

        public com.sadad.ebpp.wsdl.partnerprofileservice._1.PartnerProfileService getProxy() {
            return _proxy;
        }

        public Dispatch<Source> getDispatch() {
            if (_dispatch == null ) {
                QName portQName = new QName("http://www.sadad.com/EBPP/wsdl/PartnerProfileService/1.0", "ServicePartnerProfileService");
