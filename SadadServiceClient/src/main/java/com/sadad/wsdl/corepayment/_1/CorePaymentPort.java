...
@XmlSeeAlso({ com.sadad.scm.common._1.ObjectFactory.class, com.sadad.schema.service.corepayment._1.ObjectFactory.class, com.sadad.scm.error._1.ObjectFactory.class, com.sadad.scm.common.system._1.ObjectFactory.class })
public interface CorePaymentPort
{
	 ...
	 * 
	 * @param cancelRq
	 * @return returns com.sadad.schema.service.corepayment._1.CancelRsType
	 * @throws PaymentFault
	 */
	...
	public CancelRsType cancel(@WebParam(name = "CancelRq", targetNamespace = "http://sadad.com/schema/service/CorePayment/1.0", partName = "CancelRq") CancelRqType cancelRq) throws PaymentFault;

	/**
	 * 
	 * @param uncancelRq
	 * @return returns com.sadad.schema.service.corepayment._1.UncancelRsType
	 * @throws PaymentFault
	 */
	...
	public UncancelRsType uncancel(@WebParam(name = "UncancelRq", targetNamespace = "http://sadad.com/schema/service/CorePayment/1.0", partName = "UncancelRq") UncancelRqType uncancelRq) throws PaymentFault;

	/**
	 * 
	 * @param listByIdRq
	 * @return returns com.sadad.schema.service.corepayment._1.ListByIdRsType
	 * @throws PaymentFault
	 */
	...
	public ListByIdRsType listById(@WebParam(name = "ListByIdRq", targetNamespace = "http://sadad.com/schema/service/CorePayment/1.0", partName = "ListByIdRq") ListByIdRqType listByIdRq) throws PaymentFault;

	/**
	 * 
	 * @param listByPayorRq
	 * @return returns com.sadad.schema.service.corepayment._1.ListByPayorRsType
	 * @throws PaymentFault
	 */
	...
	public ListByPayorRsType listByPayor(@WebParam(name = "ListByPayorRq", targetNamespace = "http://sadad.com/schema/service/CorePayment/1.0", partName = "ListByPayorRq") ListByPayorRqType listByPayorRq) throws PaymentFault;

	/**
	 * 
	 * @param listByAccountRq
	 * @return returns com.sadad.schema.service.corepayment._1.ListByAccountRsType
	 * @throws PaymentFault
	 */
	...
	public ListByAccountRsType listByAccount(@WebParam(name = "ListByAccountRq", targetNamespace = "http://sadad.com/schema/service/CorePayment/1.0", partName = "ListByAccountRq") ListByAccountRqType listByAccountRq) throws PaymentFault;

	/**
	 * 
	 * @param listByBillIdRq
	 * @return returns com.sadad.schema.service.corepayment._1.ListByBillIdRsType
	 * @throws PaymentFault
	 */
	...
	public ListByBillIdRsType listByBillId(@WebParam(name = "ListByBillIdRq", targetNamespace = "http://sadad.com/schema/service/CorePayment/1.0", partName = "ListByBillIdRq") ListByBillIdRqType listByBillIdRq) throws PaymentFault;

	/**
	 * 
	 * @param listByBeneficiaryRq
	 * @return returns com.sadad.schema.service.corepayment._1.ListByBeneficiaryRsType
	 * @throws PaymentFault
	 */
	...
	public ListByBeneficiaryRsType listByBeneficiary(@WebParam(name = "ListByBeneficiaryRq", targetNamespace = "http://sadad.com/schema/service/CorePayment/1.0", partName = "ListByBeneficiaryRq") ListByBeneficiaryRqType listByBeneficiaryRq)
			throws PaymentFault;
