...
<!-- Main Table -->
<fieldset>
	<legend><fmt:message key="ebpp.portlet.label.get-rejected-payments" bundle="${bndlLang}"/></legend>
	<form name="frmAdvRejPayment" id="frmAdvRejPayment" method="post" action='<portlet:resourceURL id="RejectedPaymentsList"/>'>
			...
			<tbody>
				<tr class="DataEntryFieldRow">
					...
					<td class="outputDataCell" style="width: 80%; vertical-align: top;" nowrap>
						<input class="outputData" value="${psb.rquid}" id="fpRquid" autocomplete="off" maxlength="256" type="text" required name="param_rquid"/>
					</td>
				</tr>
					<tr class="DataEntryFieldRow">
						<td class="labelCell"style="width: 20%; vertical-align: top; height: 27" nowrap>
					...
					<tr class="DataEntryFieldRow">
						<td class="labelCell"style="width: 20%; vertical-align: top; height: 27" nowrap>
							<label class="label" for="fpAccountNumber"><fmt:message key="ebpp.portlet.label.bill-number" bundle="${bndlLang}"/> *</label>
						</td>
						<td class="outputDataCell" width="100%" valign="top" nowrap="">
							<input name="param_ebppEntityKey" class="outputData" value="${psb.ebppEntityKey}" id="txtEntityKey" autocomplete="off" maxlength="256" type="text" required/>
						</td>
					</tr>
					<tr>
						<td align="left" colspan="2">
							<input class="button" value="<fmt:message key="ebpp.portlet.button.search" bundle="${bndlLang}"/>" onclick="doQueryFormSubmission('frmAdvRejPayment', 2)" type="submit"/>
							<input class="button" value="<fmt:message key="ebpp.portlet.button.clear" bundle="${bndlLang}"/>" onclick=";" type="button"/>
							<div style="display: inline;">
								<a href="#" onclick="doPostUrl('<portlet:resourceURL id="RejectedPaymentForm"/>', 1);"><fmt:message key="ebpp.portlet.label.simple-search" bundle="${bndlLang}"/> </a>
							</div>	
						</td>
					</tr>
			</tbody>
