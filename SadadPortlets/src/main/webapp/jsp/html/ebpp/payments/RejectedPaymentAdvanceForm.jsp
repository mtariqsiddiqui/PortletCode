			...
			<tbody>
				<tr class="DataEntryFieldRow">
					...
					<td class="outputDataCell" style="width: 80%; vertical-align: top;" nowrap>
						<input type="text" name="param_rquid" id="fpRquid" value="${psb.rquid}" autocomplete="off" maxlength="36" class="rqf"/>
					</td>
				</tr>
					<tr class="DataEntryFieldRow">
						<td class="labelCell"style="width: 20%; vertical-align: top; height: 27" nowrap>
					...
					<tr class="DataEntryFieldRow">
						<td class="labelCell"style="width: 20%; vertical-align: top; height: 27" nowrap>
							<label class="label" for="txtEntityKey"><fmt:message key="ebpp.portlet.label.transaction-number" bundle="${bndlLang}"/> *</label>
						</td>
					...
					<tr>
						<td colspan="2">
							...
							<portlet:resourceURL id="RejectedPaymentAdvanceForm" var="clearURL"><portlet:param name="param_operation" value="clearSessionBeanObject"/></portlet:resourceURL>
