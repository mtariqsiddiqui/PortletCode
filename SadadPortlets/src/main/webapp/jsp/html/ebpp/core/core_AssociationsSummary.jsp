	...
	<tbody>
		...
		<c:forEach items="${psb.association}" var="asc">
			<tr>
				...
				<td>
					<portlet:resourceURL var="associationDetailsUrl" id="core_AssociationsDetails">
						<portlet:param name="officialIdNumber" value="${asc.value.officialIdNumber}"/>
						<portlet:param name="officialIdType" value="${asc.value.officialIdType}"/>
					</portlet:resourceURL>
