...
<fieldset>
	...
	<form method="post" action='<portlet:resourceURL id="RejectedAccountsList"/>' name="frmRejectedAccounts" id="frmRejectedAccounts">
			...
			<tbody>
				...
				<tr>
					<td colspan="2">
						...
						<input class="button" value="<fmt:message key="ebpp.portlet.button.search" bundle="${bndlLang}"/>" onclick="doQueryFormSubmission('frmRejectedAccounts', 2)" type="submit"/>
						<portlet:resourceURL id="RejectedAccountForm" var="clearURL"><portlet:param name="param_operation" value="clearSessionBeanObject"/></portlet:resourceURL>
						...
						<div style="display: inline-block;">
							<a href="#" onclick="doPostUrl('<portlet:resourceURL id="RejectedAccountAdvanceForm"/>', 1);"><fmt:message key="ebpp.portlet.label.advanced-search" bundle="${bndlLang}"/> </a>
						</div>
					</td>
				</tr>
			</tbody>
