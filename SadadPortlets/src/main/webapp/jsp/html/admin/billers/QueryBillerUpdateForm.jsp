						...
						<tbody>
										...
										<tbody>
											<tr class="DataEntryFieldRow">
												...
												<td class="outputDataCell" style="width: 100%" valign="top" nowrap>
													<input class="outputData" required value="${psb.selectedBiller.billerId}" maxlength="25" autocomplete="off" disabled="disabled">
													<input type="hidden" value="${psb.selectedBiller.billerId}" name="txtBillerId">
												</td>
											</tr>
											<tr class="DataEntryFieldRow">
												<td class="labelCell" valign="top" nowrap height="27">
											...
											<tr class="DataEntryFieldRow">
												...
												<td class="outputDataCell" style="width: 100%" valign="top" nowrap>
													<input name="txtSadadAccountNumber" id="txtSadadAccountNumber" class="outputData" required value="${psb.selectedBiller.billingAccountNumber}" maxlength="50" autocomplete="off">												
												</td>
											</tr>
											<tr class="DataEntryFieldRow">
												<td class="labelCell" valign="top" nowrap height="27">
											...
											<tr class="DataEntryFieldRow">
												...
												<td class="outputDataCell" style="width: 100%" valign="top" nowrap>
													<input name="txtSadadRefundAccount" id="txtSadadRefundAccount" class="outputData" required value="${psb.selectedBiller.refundAccountNumber}" maxlength="50" autocomplete="off">												
												</td>
											</tr>											
							...
							<tr>
								<td>
									...
									<input class="button" value="<fmt:message key="biller.portlet.button.save" bundle="${bndlLang}" />" onclick="$('#reqAction').val('Save');doQueryFormSubmission('frmUpdateBiller', 1);" type="submit" name="btnSave"/>
									<input class="button" value="<fmt:message key="biller.portlet.button.cancel" bundle="${bndlLang}" />" onclick="$('#reqAction').val('Cancel');doQueryFormSubmission('frmUpdateBiller', 1);" type="submit" name="btnCancel"/>
								</td>
							</tr>
						</tbody>
					</table>
