						...
						<tbody>
										...
										<tbody>
											<tr class="DataEntryFieldRow">
												...
												<td class="outputDataCell" style="width: 100%" valign="top" nowrap>
													<select name="txtPartnerKey" class="outputData" id="cmbPartnerKey" required>
														<option value="">
											...
											<tr class="DataEntryFieldRow">
												...
												<td class="outputDataCell" style="width: 100%" valign="top" nowrap>
													<input name="txtPaymentType" id="txtPaymentType" class="outputData" value="${psb.selectedPaymentType.paymentType}" maxlength="256" autocomplete="off" required="required"/>
												</td>
											</tr>
											<tr class="DataEntryFieldRow">
												<td class="labelCell" valign="top" nowrap height="27">
							...
							<tr>
								<td>									
									...
									<input class="button" value="<fmt:message key="payment-type.portlet.button.cancel" bundle="${bndlLang}" />" type="reset" name="btnCancel"/>
								</td>
							</tr>
						</tbody>
					</table>
