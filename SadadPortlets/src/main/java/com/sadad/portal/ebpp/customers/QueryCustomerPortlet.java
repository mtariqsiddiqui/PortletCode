 ...
 * 
 */
public class QueryCustomerPortlet extends SadadEbppGenericPortlet
{
...
//		SadadPortalUtils.logSessionAttributesWithValues(request, methodName, logger); // TODO remove it, just for testing purpose
