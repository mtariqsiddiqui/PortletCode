package com.sadad.portal.ebpp.files;
...
public class UploadFilePortlet extends SadadGenericPortlet
{
	...
	public static final String JSP_FOLDER = "/jsp/html/ebpp/files/"; // JSP folder name
	public static final String VIEW_JSP = "UploadFile"; // JSP file name to be rendered on the view mode
