 ...
 *
 */
public class CreateAccountPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = CreateAccountPortlet.class.getName();
	...
	public static final String JSP_FOLDER = "/jsp/html/ebpp/accounts/"; // JSP folder name
	public static final String VIEW_JSP = "CreateAccountIndex"; // JSP file name to be rendered on the view mode
