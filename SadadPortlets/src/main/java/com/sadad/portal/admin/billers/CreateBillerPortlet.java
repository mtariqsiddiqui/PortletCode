...
public class CreateBillerPortlet extends SadadGenericPortlet
{
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if(bSesObj == null)
		{
			...
			bSesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_CREATE_BILLER_FORM));
...
//		SadadPortalUtils.logSessionAttributesWithValues(request, methodName, logger);
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, java.io.IOException
	{
		...
		if(jspResourceId.equals(VIEW_JSP_CREATE_BILLER_FORM))
		{
			bh.callCreateBiller(request.getParameter("txtBillerId"), request.getParameter("txtBillerName"), request.getParameter("txtDescription"), request.getParameter("txtBankName"), request.getParameter("txtSadadAccountNumber"),
