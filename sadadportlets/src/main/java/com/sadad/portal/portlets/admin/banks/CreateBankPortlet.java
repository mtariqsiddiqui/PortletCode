package com.sadad.portal.portlets.admin.banks;
...
import com.sadad.portal.helper.BankHelper;
...
public class CreateBankPortlet extends SadadGenericPortlet
{
	...
	private BankHelper hlpObj = new BankHelper();
	private BankSessionDataBean sesObj;
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, BankSessionDataBean.class);
		if (sesObj == null)
		{
			sesObj = new BankSessionDataBean();
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_CREATE_BANK_FORM));
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, BankSessionDataBean.class);
		sesObj = populateRequestParamsInSessionBean(request, sesObj, BankSessionDataBean.class);
		sesObj = callRequiredBackEndServiceOperation(sesObj, hlpObj, BankSessionDataBean.class);
