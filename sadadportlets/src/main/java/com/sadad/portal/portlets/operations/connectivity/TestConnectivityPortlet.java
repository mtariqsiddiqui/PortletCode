 ...
 * 
 */
package com.sadad.portal.portlets.operations.connectivity;
...
import com.sadad.portal.helper.TestConnectivityHelper;

/**
 * @author Tariq Siddiqui
 *
 */
public class TestConnectivityPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = TestConnectivityPortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);

	private static final String JSP_FOLDER = "/jsp/html/operatorations/testConnectivity/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "TestConnectivityIndex";
	private static final String VIEW_JSP_TEST_CONNECTIVITY_AUTOMATIC_FORM = "TestConnectivityAutomaticForm"; // JSP file name to be rendered on the view mode

	private TestConnectivityHelper hlpObj = new TestConnectivityHelper();
	private TestConnectivitySessionDataBean sesObj;
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, TestConnectivitySessionDataBean.class);
		if (sesObj == null)
		{
			sesObj = new TestConnectivitySessionDataBean();
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_TEST_CONNECTIVITY_AUTOMATIC_FORM));
			sesObj.getScreen().setContainer2(null);
			sesObj = populateUserDetailsInSessionBean(request, sesObj, TestConnectivitySessionDataBean.class);			
		}
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, TestConnectivitySessionDataBean.class);
		sesObj = populateRequestParamsInSessionBean(request, sesObj, TestConnectivitySessionDataBean.class);
		sesObj = callRequiredBackEndServiceOperation(sesObj, hlpObj, TestConnectivitySessionDataBean.class);
