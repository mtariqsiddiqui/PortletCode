 ...
 * 
 */
package com.sadad.portal.portlets.admin.sadad;
...
import com.sadad.portal.helper.SadadAdminHelper;
...
public class SadadAdminPortlet extends SadadGenericPortlet
{
	...
	private SadadAdminHelper hlpObj = new SadadAdminHelper();
	private SadadAdminSessionDataBean sesObj = null;
	...
	protected void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, SadadAdminSessionDataBean.class);
		
		if(sesObj == null)
		{
			sesObj = hlpObj.callGetSADAD(sesObj);
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_SADAD_DETAILS));
			sesObj.getScreen().setContainer2(null);
		}
		else if (sesObj.getMessageToDisplay() != null);
			sesObj.setMessageToDisplay(null); 
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, SadadAdminSessionDataBean.class);
		sesObj = populateRequestParamsInSessionBean(request, sesObj, SadadAdminSessionDataBean.class);
		sesObj = callRequiredBackEndServiceOperation(sesObj, hlpObj, SadadAdminSessionDataBean.class);
