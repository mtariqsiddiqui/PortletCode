package com.sadad.portal.portlets.admin.branchcode;
...
import com.sadad.portal.helper.BranchCodeHelper;

public class CreateBranchCodePortlet  extends SadadGenericPortlet
{
	private static final String CLASS_NAME = CreateBranchCodePortlet.class.getName();
	...
	private static final String VIEW_JSP_CREATE_BRANCH_CODE_FORM = "CreateBranchCodeForm";
	
	private BranchCodeHelper hlpObj = new BranchCodeHelper();
	private BranchCodeSessionDataBean sesObj;
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, BranchCodeSessionDataBean.class);
		if (sesObj == null)
		{
			sesObj = new BranchCodeSessionDataBean();
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_CREATE_BRANCH_CODE_FORM));
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, BranchCodeSessionDataBean.class);
		sesObj = populateRequestParamsInSessionBean(request, sesObj, BranchCodeSessionDataBean.class);
		sesObj = callRequiredBackEndServiceOperation(sesObj, hlpObj, BranchCodeSessionDataBean.class);
