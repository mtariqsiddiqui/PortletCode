 ...
 * 
 */
package com.sadad.portal.portlets.operations.managelifecyclestatus;
...
import com.sadad.portal.beans.ManageEntityStatusSessionDataBean;
import com.sadad.portal.constant.PortalConstant;
import com.sadad.portal.helper.ManageEntityStatusHelper;

/**
 * @author Tariq Siddiqui
 *
 */
public class ManageEntityLifecycleStatusPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = ManageEntityLifecycleStatusPortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);

	private static final String JSP_FOLDER = "/jsp/html/operatorations/manageEntityLifeCycle/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "ManageEntityIndex";
	private static final String VIEW_JSP_FORM = "ManageEntityForm"; // JSP file name to be rendered on the view mode

	private ManageEntityStatusHelper hlpObj = new ManageEntityStatusHelper();
	private ManageEntityStatusSessionDataBean sesObj;
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, ManageEntityStatusSessionDataBean.class);
		if (sesObj == null)
		{
			sesObj = new ManageEntityStatusSessionDataBean();
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_FORM));
			sesObj.getScreen().setContainer2(null);
			sesObj = populateUserDetailsInSessionBean(request, sesObj, ManageEntityStatusSessionDataBean.class);
		}
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, ManageEntityStatusSessionDataBean.class);
		sesObj = populateRequestParamsInSessionBean(request, sesObj, ManageEntityStatusSessionDataBean.class);
		sesObj = callRequiredBackEndServiceOperation(sesObj, hlpObj, ManageEntityStatusSessionDataBean.class);
