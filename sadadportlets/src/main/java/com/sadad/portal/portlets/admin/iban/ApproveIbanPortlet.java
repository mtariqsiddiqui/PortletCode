...
public class ApproveIbanPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = ApproveIbanPortlet.class.getName();
	...
	private static final String VIEW_JSP_APPROVE_IBAN_FORM = "ApproveIbanForm";
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if (sesObj == null)
		{
			...
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_APPROVE_IBAN_FORM));
	...
	public void processAction(ActionRequest request, ActionResponse response) throws PortletException, IOException
	{
		...
		if(whereTo.equals(PortalConstant.BACK))
		{
			...
			if(sesObj.getAction() != null) // tackle the failure of Detail page after approval or rejection is done.
			{
				sesObj.getIbans().remove(sesObj.getSettlementId());
				sesObj.setAction(null);
				sesObj.setJustification(null);
				sesObj.setSettlementId(null);
			}
		}
