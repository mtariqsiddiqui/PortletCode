package com.sadad.portal.portlets.admin.billcategory;
...
import com.sadad.portal.helper.BillCategoryHelper;
...
public class CreateBillCategoryPortlet  extends SadadGenericPortlet
{
	...
	private BillCategoryHelper hlpObj = new BillCategoryHelper();
	private BillCategorySessionDataBean sesObj;
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, BillCategorySessionDataBean.class);
		if (sesObj == null)
		{
			sesObj = new BillCategorySessionDataBean();
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_CREATE_BILL_CATEGORY_FORM));
			sesObj.getScreen().setContainer2(null);
			sesObj = populateUserDetailsInSessionBean(request, sesObj, BillCategorySessionDataBean.class);			
		}
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, BillCategorySessionDataBean.class);
		sesObj = populateRequestParamsInSessionBean(request, sesObj, BillCategorySessionDataBean.class);
		sesObj = callRequiredBackEndServiceOperation(sesObj, hlpObj, BillCategorySessionDataBean.class);
