...
public class RejectedBillsPortlet extends SadadGenericPortlet
{
	...
	private static final String VIEW_JSP_REJECTED_BILL_FORM = "RejectedBillForm"; // JSP file name to be rendered on the view mode
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if (sesObj == null)
		{
			...
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_REJECTED_BILL_FORM));
