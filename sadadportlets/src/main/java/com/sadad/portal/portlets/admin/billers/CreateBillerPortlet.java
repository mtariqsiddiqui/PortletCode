package com.sadad.portal.portlets.admin.billers;
...
import com.sadad.portal.helper.BillerHelper;

public class CreateBillerPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = CreateBillerPortlet.class.getName();
	...
	private static final String VIEW_JSP_CREATE_BILLER_FORM = "CreateBillerForm"; // JSP file name to be rendered on the view mode

	private BillerHelper hlpObj = new BillerHelper();
	private BillerSessionDataBean sesObj;
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, BillerSessionDataBean.class);
		if (sesObj == null)
		{
			sesObj = new BillerSessionDataBean();
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_CREATE_BILLER_FORM));
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, BillerSessionDataBean.class);
		sesObj = populateRequestParamsInSessionBean(request, sesObj, BillerSessionDataBean.class);
		sesObj = callRequiredBackEndServiceOperation(sesObj, hlpObj, BillerSessionDataBean.class);
