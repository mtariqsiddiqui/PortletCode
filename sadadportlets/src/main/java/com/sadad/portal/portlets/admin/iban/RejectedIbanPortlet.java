...
public class RejectedIbanPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = RejectedIbanPortlet.class.getName();
	...
	private static final String VIEW_JSP_REJECTED_IBAN_FORM = "RejectedIbanForm";
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if (sesObj == null)
		{
			...
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_REJECTED_IBAN_FORM));
