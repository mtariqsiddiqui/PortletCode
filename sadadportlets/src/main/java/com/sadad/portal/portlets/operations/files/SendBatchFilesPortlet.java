 ...
 *
 */
public class SendBatchFilesPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = SendBatchFilesPortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);

	private static final String JSP_FOLDER = "/jsp/html/operatorations/sendBatchFiles/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "SendBatchFilesIndex";
	private static final String VIEW_JSP_FORM = "SendBatchFilesQueryForm"; // JSP file name to be rendered on the view mode
