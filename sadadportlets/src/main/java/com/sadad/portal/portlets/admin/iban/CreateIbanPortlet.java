...
public class CreateIbanPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = CreateIbanPortlet.class.getName();
	...
	private static final String VIEW_JSP_CREATE_IBAN_FORM = "CreateIbanForm";
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if (sesObj == null)
		{
			...
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_CREATE_IBAN_FORM));
