package com.sadad.portal.portlets.ebpp.refunds;
...
public class QueryRefundPortlet extends SadadGenericPortlet
{
	...
	private static final String JSP_FOLDER = "/jsp/html/ebpp/refunds/"; // JSP folder name
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if (sesObj == null)
		{
			...
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_QUERY_REFUND_FORM));
