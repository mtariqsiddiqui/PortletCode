...
public class DownloadMessageFilesPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = DownloadMessageFilesPortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);

	private static final String JSP_FOLDER = "/jsp/html/operatorations/downloadMessageFiles/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "DownloadMessageFilesIndex";
	private static final String VIEW_JSP_FORM = "DownloadMessageFilesQueryForm"; // JSP file name to be rendered on the view mode
