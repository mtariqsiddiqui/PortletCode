package com.sadad.portal.portlets.admin.servicetype;
...
import com.sadad.portal.helper.ServiceTypeHelper;

public class CreateServiceTypePortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = CreateServiceTypePortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);
	
	private static final String JSP_FOLDER = "/jsp/html/admin/servicetype/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "ServiceTypeIndex"; // JSP file name to be rendered on the view mode
	private static final String VIEW_JSP_CREATE_SERVICE_TYPE_FORM = "CreateServiceTypeForm";

	private ServiceTypeHelper hlpObj = new ServiceTypeHelper();
	private ServiceTypeSessionDataBean sesObj;
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, ServiceTypeSessionDataBean.class);
		if (sesObj == null)
		{
			sesObj = new ServiceTypeSessionDataBean();
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_CREATE_SERVICE_TYPE_FORM));
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, IOException
	{
		...
		sesObj = getSessionBeanObject(request, ServiceTypeSessionDataBean.class);
		sesObj = populateRequestParamsInSessionBean(request, sesObj, ServiceTypeSessionDataBean.class);
		sesObj = callRequiredBackEndServiceOperation(sesObj, hlpObj, ServiceTypeSessionDataBean.class);
