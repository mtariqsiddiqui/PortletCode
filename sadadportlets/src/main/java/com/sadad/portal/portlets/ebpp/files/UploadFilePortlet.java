...
public class UploadFilePortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = UploadFilePortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);

	private static final String JSP_FOLDER = "/jsp/html/ebpp/files/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "UploadFileIndex"; // JSP file name to be rendered on the view mode	
	private static final String VIEW_JSP_UPLOAD_FILE_FORM = "UploadFileForm"; // JSP file name to be rendered on the view mode
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if (sesObj == null)
		{
			...
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_UPLOAD_FILE_FORM));
