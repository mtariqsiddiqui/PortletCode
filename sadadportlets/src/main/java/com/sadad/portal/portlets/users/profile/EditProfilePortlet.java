 ...
 * 
 */
public class EditProfilePortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = EditProfilePortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);
	
	private static final String JSP_FOLDER = "/jsp/html/users/editprofile/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "EditProfileIndex"; // JSP file name to be rendered on the view mode
	private static final String VIEW_JSP_EDIT_PROFILE_FORM = "EditProfileForm";
