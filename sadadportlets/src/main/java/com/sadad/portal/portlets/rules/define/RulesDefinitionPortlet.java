package com.sadad.portal.portlets.rules.define;
...
public class RulesDefinitionPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = RulesDefinitionPortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);
	
	private static final String JSP_FOLDER = "/jsp/html/rules/define/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "RulesDefinitionIndex"; // JSP file name to be rendered on the view mode
	private static final String VIEW_JSP_RULES_DEFINITION_FORM = "RulesDefinitionForm";
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if (sesObj == null)
		{
			...
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_RULES_DEFINITION_FORM));
