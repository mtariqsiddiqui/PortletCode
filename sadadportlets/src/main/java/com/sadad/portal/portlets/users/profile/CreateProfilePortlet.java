 ...
 * 
 */
public class CreateProfilePortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = CreateProfilePortlet.class.getName();
	private static final Logger logger = Logger.getLogger(CLASS_NAME);
	
	private static final String JSP_FOLDER = "/jsp/html/users/createprofile/"; // JSP folder name
	private static final String VIEW_JSP_INDEX = "CreateProfileIndex"; // JSP file name to be rendered on the view mode
	private static final String VIEW_JSP_SEARCH_PROFILE_FORM = "CreateProfileForm";
