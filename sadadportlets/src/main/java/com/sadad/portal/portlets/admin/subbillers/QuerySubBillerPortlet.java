...
public class QuerySubBillerPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = QuerySubBillerPortlet.class.getName();
	...
	private static final String VIEW_JSP_QUERY_SUBBILLER_FORM = "QuerySubBillerForm"; // JSP file name to be rendered on the view mode
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if (sesObj == null)
		{
			...
			sesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_QUERY_SUBBILLER_FORM));
