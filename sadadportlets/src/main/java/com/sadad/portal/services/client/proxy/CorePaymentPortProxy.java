...
import com.sadad.wsdl.corepayment._1.CorePaymentService;
...
public class CorePaymentPortProxy
{
	...
	{
		private CorePaymentService _service = null;
		private CorePaymentPort _proxy = null;
		...
		{
			_service = new CorePaymentService(wsdlLocation, serviceName);
			initCommon();
		}
		...
		public void init()
		{
			...
			_proxy = null;
			_dispatch = null;
			_service = new CorePaymentService();
			initCommon();
		}
		...
		public Dispatch<Source> getDispatch()
		{
			if (_dispatch == null)
			{
				QName portQName = new QName("", "CorePaymentPort");
	...
	{
		return _getDescriptor().getProxy().listSPLPayments(listSPLPaymentsRq);
	}
