...
import com.sadad.ebpp.wsdl.auditservice._1.AuditService;
...
public class AuditServiceProxy
{
	...
	public class Descriptor
	{
		...
		private AuditServicePort _proxy = null;
		...
		{
			_service = new AuditService(wsdlLocation, serviceName);
			initCommon();
		}
		...
		{
			_proxy = _service.getAuditServicePort();
		}

		public AuditServicePort getProxy()
		{
			return _proxy;
		}
		...
		public Dispatch<Source> getDispatch()
		{
			if (_dispatch == null)
			{
				QName portQName = new QName("", "AuditService");
	...
	public AuditServiceProxy(URL wsdlLocation, QName serviceName)
	{
	...
	{
		return _getDescriptor().getProxy().listAudit(listAuditRq);
	}
