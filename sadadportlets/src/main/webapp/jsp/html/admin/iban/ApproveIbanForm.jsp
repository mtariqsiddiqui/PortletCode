		...
		<tr>
			<td>
				<fieldset>
					...
					<form name="frmApproveIban" id="frmApproveIban" method="post" action='<portlet:resourceURL id="ApproveIbanList"/>'>
						<table style="width: 100%">
							<tbody>
								<tr>
									<td>
								...
								<tr>
									<td>
										<input type="hidden" name="param_status" value="PENDING" />
										<input type="hidden" name="param_operation" value="callListIban" />
										<input class='button' value='<fmt:message key="iban.portlet.button.search" bundle="${bndlLang}"/>' onclick='doQueryFormSubmission("frmApproveIban");' type='submit' />
										<portlet:resourceURL id="ApproveIbanForm" var="clearURL"><portlet:param name="param_operation" value="clearSessionBeanObject"/></portlet:resourceURL>
