...
<h3>This portlet is deprecated, please use <i>File Download functionality from EBPP</i> section to download files.</h3>
<!-- form name="frmSendBatchFile" id="frmSendBatchFile" method="post" action="<portlet:resourceURL id="DownloadMessageFilesSummary" />">
	...
	<tbody>
		...
		<tr>
			<td>
				<fieldset>
					<legend>
						<fmt:message key="ow.portlet.label.download-message-files" bundle="${bndlLang}" />
					</legend>
					<table style="width: 100%;">
						<tr>
							<td>
								<table class="dataEntryPageTable" style="width: 100%;">
									<tbody>
										...
										<tr class="DataEntryFieldRow">
											<td class="labelCell" width="200px" valign="top" nowrap height="27">
												<label class="label" for="txtRquid">
													<fmt:message key="ow.portlet.label.rquid" bundle="${bndlLang}" />
												</label>
											</td>
											<td class="outputDataCell" style="width: 100%;" valign="top" nowrap>
												<input name="param_rquid" class="outputData" value="${psb.rquid}" id="txtRquid" type="text" autocomplete="off" maxlength="50" />
											</td>
										</tr>
										<tr class="DataEntryFieldRow">
											<td class="labelCell" width="200px" valign="top" nowrap height="27">
										...
										<tr class="DataEntryFieldRow">
											<td class="labelCell" valign="top" nowrap height="27" style="width: 200px;">
												<label class="label" for="StartDt_field">
													<fmt:message key="ow.portlet.label.arrival-date" bundle="${bndlLang}" /> *
												</label>
											</td>
											<td class="outputDataCell" width="100%" valign="top" nowrap>
												<label class="label" for="txtArrivalFromDate"><fmt:message key="ow.portlet.label.from" bundle="${bndlLang}" />
													<input class="outputData readonly" value="${psb.arrivalDateFrom}" id="txtArrivalFromDate" 
														autocomplete="off" maxlength="10" type="text" required placeholder="YYYY-MM-DD" />
												</label>
												<label class="label" for="txtArrivalToDate"><fmt:message key="ow.portlet.label.to" bundle="${bndlLang}" />
													<input class="outputData readonly" value="${psb.arrivalDateTo}" id="txtArrivalToDate" 
														autocomplete="off" maxlength="10" type="text" required placeholder="YYYY-MM-DD" />
												</label>
											</td>
											</tr>
											...
											<tr class="DataEntryFieldRow">
												<td class="labelCell" valign="top" nowrap height="27" style="width: 200px;">
													<label class="label" for="ProcessingDateRange_StartDt_field">
														<fmt:message key="ow.portlet.label.processing-date" bundle="${bndlLang}" />
													</label>
												</td>
												<td class="outputDataCell" width="100%" valign="top" nowrap>
													 <label class="label" for="txtProcessFromDate"><fmt:message key="ow.portlet.label.from" bundle="${bndlLang}" />
														<input class="outputData readonly" value="${psb.processedDateFrom}" id="txtProcessFromDate" 
															autocomplete="off" maxlength="10" type="text" required placeholder="YYYY-MM-DD" />
													</label>
													<label class="label" for="txtProcessToDate"><fmt:message key="ow.portlet.label.to" bundle="${bndlLang}" />
														<input class="outputData readonly" value="${psb.processedDateTo}" id="txtProcessToDate" 
															autocomplete="off" maxlength="10" type="text" required placeholder="YYYY-MM-DD" />
													</label>
												</td>
											</tr>
						...
						<tr>
							<td>
								<input type="hidden" id="txtDateRangeFrom" name="param_dateRangeFrom" value="" />
								<input type="hidden" id="txtDateRangeTo" name="param_dateRangeTo" value="" />
								...
								<portlet:resourceURL id="DownloadMessageFilesQueryForm" var="clearURL"><portlet:param name="param_operation" value="clearSessionBeanObject"/></portlet:resourceURL>
