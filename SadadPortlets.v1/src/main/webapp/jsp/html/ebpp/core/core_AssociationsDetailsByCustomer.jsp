			...
			<td>
				...
				<table style="width: 100%">
					<tbody>
												...
												<table class="tableclass">
													<tbody>
														...
														<tr>
															...
															<td style="width: 25%;">${psb.association[psb.associationKey].assigningOrganization}</td>
														</tr>
													</tbody>
												</table>
											</td>
						...
						<tr>
							<td>
								<portlet:resourceURL var="accountSummaryUrl" id="core_AccountSummary">
									<portlet:param name="param_accountNumber" value="${psb.association[psb.associationKey].accountNumber}"/>
									<portlet:param name="param_billerId" value="${psb.association[psb.associationKey].billerId}"/>
								</portlet:resourceURL>
								<input type="button" class="button" onclick="doPostUrl('${accountSummaryUrl}', 2)" value="<fmt:message key="ebpp.portlet.button.account" bundle="${bndlLang}" />" />								
