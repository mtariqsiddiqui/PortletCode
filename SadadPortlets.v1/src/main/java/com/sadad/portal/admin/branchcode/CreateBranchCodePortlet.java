...
public class CreateBranchCodePortlet  extends SadadGenericPortlet
{
	...
	public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException
	{
		...
		if(bcSesObj == null)
		{
			...
			bcSesObj.getScreen().setContainer1(getJspFilePath(JSP_FOLDER, VIEW_JSP_CREATE_BRANCH_CODE_FORM));
...
//		SadadPortalUtils.logSessionAttributesWithValues(request, methodName, logger);
	...
	public void serveResource(ResourceRequest request, ResourceResponse response) throws PortletException, java.io.IOException
	{
		...
		if(jspResourceId.equals(VIEW_JSP_CREATE_BRANCH_CODE_FORM))
		{
			bch.callCreateBankBranch(request.getParameter("txtPartnerKey"), request.getParameter("txtBranchCode"));
		}
