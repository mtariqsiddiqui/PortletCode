...
public class CreatePaymentPortlet extends SadadGenericPortlet
{
	private static final String CLASS_NAME = CreatePaymentPortlet.class.getName();
	...
	public static final String VIEW_JSP = "CreatePayment"; // JSP file name to be rendered on the view mode
